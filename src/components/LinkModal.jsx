...
const LinkModal = ({ link, onClose, onSave, isEditing }) => {
  ...
  useEffect(() => {
    if (link) {
      // When editing, we expect link to have _id and other fields.
      setFormData(link);
    }
  }, [link]);
  ...
  const handleSubmit = (e) => {
    ...
    if (isEditing) {
      // For editing, send JSON with the _id included.
      const updatedLink = {
        _id: link._id, // ensure _id is passed
      ...
      // For new links, use FormData to include the file.
